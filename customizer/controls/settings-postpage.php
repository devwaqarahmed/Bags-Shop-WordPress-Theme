...
$wp_customize->add_setting( 'complete[sidebarborder_color_id]', array(
	...
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebarborder_color_id', array(
				'label' => __('Sidebar Widget Title Border Color','complete'),
				'section' => 'general_color_section',
...
$wp_customize->add_setting( 'complete[testimonial_background_color]', array(
	'type' => 'option',
	'default' => '#ffffff',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'testimonial_background_color', array(
	'label' => __('Testimonial Background Color','complete'),
	'section' => 'general_color_section',
	'settings' => 'complete[testimonial_background_color]',
) ) );

// Testimonial Text Color
$wp_customize->add_setting( 'complete[testimonial_text_color]', array(
	'type' => 'option',
	'default' => '#282828',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'testimonial_text_color', array(
	'label' => __('Testimonial Text Color','complete'),
	'section' => 'general_color_section',
	'settings' => 'complete[testimonial_text_color]',
) ) );

// Testimonial Quote Color
$wp_customize->add_setting( 'complete[testimonial_quote_color]', array(
	'type' => 'option',
	'default' => '#4223af',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'testimonial_quote_color', array(
	'label' => __('Testimonial Quote Color','complete'),
	'section' => 'general_color_section',
	'settings' => 'complete[testimonial_quote_color]',
) ) );

// Testimonial Bullet Color
$wp_customize->add_setting( 'complete[testimonial_bullet_color]', array(
	'type' => 'option',
	'default' => '#ffffff',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'testimonial_bullet_color', array(
	'label' => __('Testimonial Bullet Color','complete'),
	'section' => 'general_color_section',
	'settings' => 'complete[testimonial_bullet_color]',
) ) );

// Testimonial Active Bullet Color
$wp_customize->add_setting( 'complete[testimonial_active_bullet_color]', array(
	'type' => 'option',
	'default' => '#a88057',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'testimonial_active_bullet_color', array(
	'label' => __('Testimonial Active Bullet Color','complete'),
	'section' => 'general_color_section',
	'settings' => 'complete[testimonial_active_bullet_color]',
) ) );
...
$wp_customize->add_setting( 'complete[post_meta_icon_color]', array(
	'type' => 'option',
	'default' => '#a88057',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'post_meta_icon_color', array(
				'label' => __('Post Meta Icon Color','complete'),
				'section' => 'general_color_section',
				'settings' => 'complete[post_meta_icon_color]',
			) ) );
...
$wp_customize->add_setting( 'complete[product_button_color]', array(
	'type' => 'option',
	'default' => '#ffffff',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'product_button_color', array(
				'label' => __('Product Button Color','complete'),
				'section' => 'general_color_section',
				'settings' => 'complete[product_button_color]',
			) ) );

// Product Button Background Color
$wp_customize->add_setting( 'complete[product_button_background_color]', array(
	'type' => 'option',
	'default' => '#000000',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'product_button_background_color', array(
				'label' => __('Product Button Background Color','complete'),
				'section' => 'general_color_section',
				'settings' => 'complete[product_button_background_color]',
			) ) );

// Product Button Hover Color
$wp_customize->add_setting( 'complete[product_button_hover_color]', array(
	'type' => 'option',
	'default' => '#ffffff',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'product_button_hover_color', array(
				'label' => __('Product Button Hover Color','complete'),
				'section' => 'general_color_section',
				'settings' => 'complete[product_button_hover_color]',
			) ) );

// Product Button Hover Background Color
$wp_customize->add_setting( 'complete[product_button_hover_background_color]', array(
	'type' => 'option',
	'default' => '#a88057',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'product_button_hover_background_color', array(
				'label' => __('Product Button Hover Background Color','complete'),
				'section' => 'general_color_section',
				'settings' => 'complete[product_button_hover_background_color]',
			) ) );
