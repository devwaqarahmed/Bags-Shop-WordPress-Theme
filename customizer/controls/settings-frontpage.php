...
// Slider Arrow Color
$wp_customize->add_setting( 'complete[slider_arrow_color]', array(
	'type' => 'option',
	'default' => '#000000',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'slider_arrow_color', array(
				'label' => __('Slider Arrow Color','complete'),
				'section' => 'slider_section',
				'settings' => 'complete[slider_arrow_color]',
			) ) );

// Slider Arrow Hover Color
$wp_customize->add_setting( 'complete[slider_arrow_hover_color]', array(
	'type' => 'option',
	'default' => '#a88057',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'slider_arrow_hover_color', array(
				'label' => __('Slider Arrow Hover Color','complete'),
				'section' => 'slider_section',
				'settings' => 'complete[slider_arrow_hover_color]',
			) ) );
...
// Slide Font Typography And Colors
	...
	$wp_customize->add_setting('complete[slide_title1]', array(
		'type' => 'option',
		'default'	=> __('<small>Get ready for</small>Stylish Bags','complete'),
