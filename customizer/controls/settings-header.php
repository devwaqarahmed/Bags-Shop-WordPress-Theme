...
$wp_customize->add_setting('complete[phntp_text_id]', array(
	'type' => 'option',
	'default' => __('Free shipping on orders over $80','complete'),
...
$wp_customize->add_setting('complete[emltp_text]', array(
	'type' => 'option',
	'default' => __('<i class="fa fa-envelope-o"></i> sales@yourstorename.com','complete'),
	'sanitize_callback' => 'wp_kses_post',
	'transport' => 'postMessage',
) );
...
$wp_customize->add_setting('complete[suptp_text]', array(
	'type' => 'option',
	'default' => __('<a href="#" class="skt-subcsribe-btn">SUBSCRIBE & SAVE</a>','complete'),
	'sanitize_callback' => 'wp_kses_post',
	'transport' => 'postMessage',
) );
...
// Topbar Button Color
$wp_customize->add_setting( 'complete[header_button_color]', array(
	'type' => 'option',
	'default' => '#ffffff',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_button_color', array(
				'label' => __('Topbar Button Color','complete'),
				'section' => 'headheader_section',
				'settings' => 'complete[header_button_color]',
			) ) );

// Topbar Button Background Color
$wp_customize->add_setting( 'complete[header_button_background_color]', array(
	'type' => 'option',
	'default' => '#000000',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_button_background_color', array(
				'label' => __('Topbar Button Background Color','complete'),
				'section' => 'headheader_section',
				'settings' => 'complete[header_button_background_color]',
			) ) );

// Topbar Button Hover Color
$wp_customize->add_setting( 'complete[header_button_hover_color]', array(
	'type' => 'option',
	'default' => '#ffffff',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_button_hover_color', array(
				'label' => __('Topbar Button Hover Color','complete'),
				'section' => 'headheader_section',
				'settings' => 'complete[header_button_hover_color]',
			) ) );

// Topbar Button Hover Background Color
$wp_customize->add_setting( 'complete[header_button_hover_background_color]', array(
	'type' => 'option',
	'default' => '#383838',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_button_hover_background_color', array(
				'label' => __('Topbar Button Hover Background Color','complete'),
				'section' => 'headheader_section',
				'settings' => 'complete[header_button_hover_background_color]',
			) ) );
...
$wp_customize->add_setting( 'complete[menu_bar_background_color]', array(
	'type' => 'option',
	'default' => '#f6f6f6',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'menu_bar_background_color', array(
				'label' => __('Menu Bar Background Color','complete'),
				'section' => 'headheader_section',
				'settings' => 'complete[menu_bar_background_color]',
			) ) );
