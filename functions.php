<?php
/**
 * The MAIN FUNCTIONS FILE for Shopzee Pro
 *
...
function woocommerce_header_add_to_cart_fragment( $fragments ) {
	...
	?>
	<a class="cart-customlocation" href="<?php echo wc_get_cart_url(); ?>" title="<?php _e( 'View Cart' ); ?>"> <i class="fa fa-shopping-cart" aria-hidden="true"></i> <span class="custom-cart-count"><?php echo WC()->cart->get_cart_contents_count(); ?></span></a>
	<?php
