<?php 
/**
 * The Custom Style for Shopzee Pro
 *
...
.wpcf7-form-control.wpcf7-submit{background-color:<?php echo $complete['all_buttons_background_color'] ?> !important; color:<?php echo $complete['all_buttons_color'] ?> !important;}
...
.wpcf7-form-control.wpcf7-submit:hover{background-color:<?php echo $complete['all_buttons_hover_background_color'] ?> !important; color:<?php echo $complete['all_buttons_hover_color'] ?> !important;}

.woocommerce #respond input#submit.alt,
.woocommerce a.button.alt,
.woocommerce button.button.alt,
.woocommerce input.button.alt{background-color:<?php echo $complete['all_buttons_background_color'] ?> !important; color:<?php echo $complete['all_buttons_color'] ?> !important;}

.woocommerce #respond input#submit.alt:hover,
.woocommerce a.button.alt:hover,
.woocommerce button.button.alt:hover,
.woocommerce input.button.alt:hover{background-color:<?php echo $complete['all_buttons_hover_background_color'] ?> !important; color:<?php echo $complete['all_buttons_hover_color'] ?> !important;}

.woocommerce #respond input#submit.disabled, .woocommerce #respond input#submit:disabled, .woocommerce #respond input#submit:disabled[disabled], .woocommerce a.button.disabled, .woocommerce a.button:disabled, .woocommerce a.button:disabled[disabled], .woocommerce button.button.disabled, .woocommerce button.button:disabled, .woocommerce button.button:disabled[disabled], .woocommerce input.button.disabled, .woocommerce input.button:disabled, .woocommerce input.button:disabled[disabled]{background-color:<?php echo $complete['all_buttons_background_color'] ?>; color:<?php echo $complete['all_buttons_color'] ?>;}
.woocommerce #respond input#submit.disabled:hover, .woocommerce #respond input#submit:disabled:hover, .woocommerce #respond input#submit:disabled[disabled]:hover, .woocommerce a.button.disabled:hover, .woocommerce a.button:disabled:hover, .woocommerce a.button:disabled[disabled]:hover, .woocommerce button.button.disabled:hover, .woocommerce button.button:disabled:hover, .woocommerce button.button:disabled[disabled]:hover, .woocommerce input.button.disabled:hover, .woocommerce input.button:disabled:hover, .woocommerce input.button:disabled[disabled]:hover{background-color:<?php echo $complete['all_buttons_background_color'] ?>; color:<?php echo $complete['all_buttons_color'] ?>;}


.woocommerce-message::before,
.woocommerce-info::before{color: <?php echo $complete['sec_color_id'] ?>;}
.woocommerce-message,
.woocommerce-info{border-top-color: <?php echo $complete['sec_color_id'] ?>;}

.woocommerce ul.products li.product .onsale,
.woocommerce span.onsale{background-color: <?php echo $complete['sec_color_id'] ?>;}
...
.skt-home-posts-row .skt-home-posts-date i{color:<?php echo $complete['post_meta_icon_color'] ?>;}

.skt-team-row .skt-team-title a{color:<?php echo $complete['team_title_color'] ?>;}
.skt-team-row .skt-team-designation{color:<?php echo $complete['team_designation_color'] ?>;}
	
.head-info-area .skt-subcsribe-btn{background-color:<?php echo $complete['header_button_background_color'] ?>; color:<?php echo $complete['header_button_color'] ?>;}
.head-info-area .skt-subcsribe-btn:hover,
.head-info-area .skt-subcsribe-btn:hover:after{background-color:<?php echo $complete['header_button_hover_background_color'] ?>; color:<?php echo $complete['header_button_hover_color'] ?>;}

.woocommerce ul.products li.product .woocommerce-loop-category__title,
.woocommerce ul.products li.product .woocommerce-loop-product__title,
.woocommerce ul.products li.product h3,
.skt-bestseller-products .skt-bestseller-products-title,
.skt-bestseller-products .skt-bestseller-products-title a{color:<?php echo $complete['product_title_color'] ?>;}
.woocommerce ul.products li.product .price,
.skt-bestseller-products .skt-bestseller-products-price{color:<?php echo $complete['product_price_color'] ?>;}
.woocommerce ul.products li.product .button{background-color:<?php echo $complete['product_button_background_color'] ?> !important; color:<?php echo $complete['product_button_color'] ?> !important;}
.woocommerce ul.products li.product .button:hover{background-color:<?php echo $complete['product_button_hover_background_color'] ?> !important; color:<?php echo $complete['product_button_hover_color'] ?> !important;}
/*-----------------------------COLORS------------------------------------*/
		/*Header Color*/
		...
		.slider-main .theme-default .nivo-directionNav a{background-color:<?php echo $complete['slider_arrow_color']; ?>}
		.slider-main .theme-default .nivo-directionNav a:hover{background-color:<?php echo $complete['slider_arrow_hover_color']; ?>}
		...
		.skt-testimonials .skt-testimonial-box{background-color:<?php echo $complete['testimonial_background_color']; ?>;}
		.skt-testimonials .skt-testimonial-title,
		.skt-testimonials .skt-testimonial-designation,
		.skt-testimonials .skt-testimonial-content{color:<?php echo $complete['testimonial_text_color']; ?>;}
		.skt-testimonials .owl-dots .owl-dot{background-color: <?php echo $complete['testimonial_bullet_color']; ?>;}
		.skt-testimonials .owl-dots .owl-dot.active{background-color: <?php echo $complete['testimonial_active_bullet_color']; ?>;}
		...
		/*MENU Text Color*/
		.topmenu-bar{background-color: <?php echo $complete['menu_bar_background_color'] ?>;}
...
/*Widget Title Color */
#sidebar .widget .widgettitle{border-color:<?php echo $complete['sidebarborder_color_id'] ?>; color:<?php echo $complete['sidebar_tt_color_id'] ?>; font-size:<?php echo $complete['wgttitle_size_id']; ?>;}
...
.footer-infobox-newsletter{background-color: <?php echo $complete['footer_infobox_bg_color']; ?>;}
.footer-infobox{background-color: <?php echo $complete['footer_infobox_bg_color2']; ?>; border-color: <?php echo $complete['footer_infobox_border_color2']; ?>;}
