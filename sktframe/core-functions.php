<?php
/**
 * The Core Functions for Shopzee Pro
 *
				...
				<div class="skt-team-col">
					<div class="skt-team-inner">
						...
						<div class="skt-team-content">
							<h4 class="skt-team-title"><a href="'.get_permalink().'">'.get_the_title().'</a></h4>
							<span class="skt-team-designation">'.$designation.'</span>
						</div>
					</div>
				</div>';
		}
	} else {
		$ourtm .= '<p>No team member found.</p>';
	}
	wp_reset_query();
	$ourtm .= '</div>';
    return $ourtm;
...
// Shortcode Promobox1
/* [promobox1 bgcolor="#f7f7f7" topbordercolor="#a88057" otherbordercolor="#e8e6e6"]Description[/promobox1] */
...
// Shortcode Promobox2
/* [promobox2 bgcolor="#f7f7f7" leftbordercolor="#a88057" button="Hello Text" url="#"]Description[/promobox2] */
...
// Shortcode Promobox3
/* [promobox3 bgcolor="#f7f7f7" bottombordercolor="#a88057" button="Hello Text" url="#"]Description[/promobox3] */
...
// Shortcode Promobox4
/* [promobox4 bgcolor="#f7f7f7" bordercolor="#a88057"]Description[/promobox4] */
    	...
    	<div class="skt-home-posts-inner">
        	<div class="skt-home-posts-thumb">
				<?php if(has_post_thumbnail() ) { ?>
                    <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php the_post_thumbnail( get_the_ID(), 'full' ); ?></a>
                <?php } else { ?>
                    <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/default-post-img.jpg"></a>
                <?php } ?>
			</div>
            <div class="skt-home-posts-content">
            	<span class="skt-home-posts-date"><i class="fa fa-calendar" aria-hidden="true"></i><?php the_time('F d, Y'); ?><i class="fa fa-user" aria-hidden="true" style="margin-left: 20px;"></i><?php the_author(); ?></span>
				...
				<a class="skt-home-posts-more" href="<?php the_permalink(); ?>">Read More</a>
            </div>
        </div>
     </div>
  ...
  <div class="owl-carousel skt-testimonials">
	...
	<div class="item">
		<div class="skt-testimonial-box">
			<div class="skt-testimonial-quote"><i class="fa fa-quote-right" aria-hidden="true"></i></div>
			<div class="skt-testimonial-info">
				...
				<span class="skt-testimonial-designation"><?php echo $companyname; ?> - <?php echo $position; ?></span>
			</div>
...
add_shortcode( 'testimonial-slider', 'testimonial_slider_func' );

//[bestseller-products-carousel limit="3"]
function bestseller_products_carousel_func( $atts ) {
   extract( shortcode_atts( array(
    'limit' => '6'
  ), $atts ) );
  ...
  <div class="owl-carousel skt-bestseller-products">
	<?php $args = array( 'post_type' => 'product', 'meta_key' => 'total_sales', 'orderby' => 'meta_value_num', 'posts_per_page' => $limit );
	query_posts( $args );
	...
	?>
	<div class="item">
		<div class="skt-bestseller-products-box">
        	<div class="skt-bestseller-products-thumb">
                ...
                <div class="skt-bestseller-products-tag"><?php _e("Best Seller") ?></div>
            </div>
            <h3 class="skt-bestseller-products-title"><a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php the_title(); ?></a></h3>
            <div class="skt-bestseller-products-price"><?php echo $product->get_price_html(); ?></div>
        </div>		
	</div>
    <?php } } else { ?><p>Sorry! There are no products.</p> <?php  } ?>
...
add_shortcode( 'bestseller-products-carousel', 'bestseller_products_carousel_func' );